...
extern NSString *const SSGCDAsyncUdpSocketException;
extern NSString *const SSGCDAsyncUdpSocketErrorDomain;

extern NSString *const SSGCDAsyncUdpSocketQueueName;
extern NSString *const SSGCDAsyncUdpSocketThreadName;

enum SSGCDAsyncUdpSocketError
{
	SSGCDAsyncUdpSocketNoError = 0,          // Never used
	SSGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	SSGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	SSGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	SSGCDAsyncUdpSocketClosedError,          // The socket was closed
	SSGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
typedef enum SSGCDAsyncUdpSocketError SSGCDAsyncUdpSocketError;
 ...
 * Example:
 * 
 * SSGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^SSGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id *context);
 ...
 *
**/
typedef BOOL (^SSGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface SSGCDAsyncUdpSocket : NSObject

/**
 * SSGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * 
 * This means SSGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, SSGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, SSGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, SSGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that SSGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about SSGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(SSGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(SSGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * SSGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, SSGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about SSGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(SSGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(SSGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The SSGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally SSGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
...
@protocol SSGCDAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(SSGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(SSGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(SSGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(SSGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(SSGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(SSGCDAsyncUdpSocket *)sock withError:(NSError *)error;
